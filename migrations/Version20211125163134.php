 ...
 */
final class Version20211125163134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (
            ...
            INDEX IDX_527EDB25BAD26311 (tag_id), 
            INDEX IDX_527EDB25A76ED395 (user_id), 
            INDEX IDX_527EDB256BF700BD (status_id), 
            PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (
            ...
            is_prefered TINYINT(1) NOT NULL, 
